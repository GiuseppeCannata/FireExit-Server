...
<body>
	...
	<p>
		Qui puoi inserire un nuovo arco. <a target="_blank"
			href="${pageContext.request.contextPath}/TabellaNodi">Clicca qui
		</a> per avere la lista dei nodi
	<p>
		<br>
	<p class="errore">${errorString}</p>

	<form id="form" method="POST"
		action="${pageContext.request.contextPath}/InserimentoArco">
		<table border="0">
			<tr>
			...
			<tr>
				<td>Piano</td>
				<td><input name="piano" readonly="readonly" type="text"
					value="${piano}"></td>
			</tr>
			<tr>
				<td><input name="NPesi" readonly="readonly" type="HIDDEN"
					value="${NPesi}"></td>
			</tr>
