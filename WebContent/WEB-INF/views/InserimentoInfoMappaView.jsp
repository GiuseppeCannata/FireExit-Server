...
<body>
	...
	<p>Qui puoi inserire le info relative alla mappa. In seguito verrai
		reindirizzato alla mappa per l aggiunta delle altre info relative ad
		archi e nodi
	<p>
		<br>
	...
	<form id="form" method="POST"
		action="${pageContext.request.contextPath}/InserimentoInfoMappa"
		...
		<table border="0">
			...
			<tr>
				<td>Piantina</td>
				<td><input type="file" name="piantina" accept=".png"></td>
			<tr>
				<td colspan="2">
