	...
	<table border="1" cellpadding="5" cellspacing="1">
		...
		<c:forEach items="${ListMappe}" var="mappa">
			<tr>
				...
				<td><a
					href="${pageContext.request.contextPath}/CaricaMappa?piano=${mappa.getPiano()}">Vai</a></td>
				<td><a id="delete${mappa.getPiano()}" href="#"
					onclick="elimina(event,'${pageContext.request.contextPath}/EliminaMappa?piano=${mappa.getPiano()}','${mappa.getPiano()}')">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
